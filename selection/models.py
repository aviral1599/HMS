...
class Complaints(models.Model):
    complaint_choice = [('P', 'Plumbing'), ('E', 'Electrician'), ('C', 'Carpeneter'),('A', 'AC Repair')]
    customer_name = models.CharField(max_length=120)
    email = models.EmailField()
    room_no = models.CharField(max_length=10)
    Complaint_type = models.CharField(choices=complaint_choice, max_length=1, default=None)
    details = models.TextField()
    date_submit = models.DateTimeField(default=now, blank=True)
